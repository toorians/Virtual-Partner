...
import ProjectsChart from '../components/projects/projects';
                    ...
                    <Row>
                        <Col xxl={{ span: 9, order: 1 }} md={{ span: 12, order: 1 }} xs={{ span: 24 }} className="margin-bottom">
                            <div className='home-div1 first-div'>
                                <h1 className='h1 mb-0'>Add Project</h1>
                                <p className='p2'>Create a new project on ProManage.
                                 Collaborate your work. Directory to
                                  your local projects</p>
                                <ProjectsBtn />
                            </div>
                        </Col>
                        <Col xxl={{ span: 9, order: 2 }} md={{ span: 12, order: 2 }} xs={{ span: 24 }} className="margin-bottom">
                            <div className='home-div3'>
                                ...
                                <div className='products-charts'>
                                    <ProjectsChart value="50" />
                                    <ProjectsChart value="20" />
                                    <ProjectsChart value="15" />
                                    <ProjectsChart value="5" />
                                    <ProjectsChart value="10" />
                                </div>
